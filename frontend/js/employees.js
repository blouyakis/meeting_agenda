...
document.getElementById('add-employee-btn').addEventListener('click', () => {
  ...
  ['emp-first', 'emp-last', 'emp-department', 'emp-email', 'emp-phone'].forEach((id) => document.getElementById(id).value = '');
...
document.getElementById('employees-tbody').addEventListener('click', async (e) => {
